...
<main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-8 mx-auto text-center">
                    <h2 class="fw-bold text-lteal mb-5 pb-4"><?php echo esc_html($animal_nutrition_block_2['animal_nutrition_block_2_title']) ?></h2>
                </div>
                        ...
                        <div class="col-12 col-md-4 text-center text-lg-start mb-5 mb-xl-0">
                            ...
                            <div class="card border-0 bg-transparent text-center">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <span class="fw-bold fs-4 text-lteal"><?php echo esc_html($get_pharm_icon['animal_nutrition_block_2_title']); ?></span>
                                    </div>
    ...
    <?php if(!empty($animal_nutrition_block_3['animal_nutrition_block_3_content'])) :?>
        <section id="added_block" class="bg-lteal">
          <div class="container">
            <?php if(!empty($animal_nutrition_block_3['animal_nutrition_block_3_title'])) :?>
            <h2 class="fw-bold text-center mb-5 pb-lg-5"><?php echo esc_html( $animal_nutrition_block_3['animal_nutrition_block_3_title'] );?></h2>
            <?php endif;?>
            <div class="row">
              <div class="col-12 col-lg-6 mt-5 mt-lg-0 text-center text-lg-start">
                <div class="lh-lg text-secondary">
                    <?php echo html_entity_decode(esc_html($animal_nutrition_block_3['animal_nutrition_block_3_content'])); ?>
                </div>
                
              </div>
              <div class="col-12 col-lg-6 ps-lg-5 mt-5 mt-lg-0">
                <?php if (!empty($animal_nutrition_block_3['animal_nutrition_block_3_image']['url'])) : ?>
                    <?php
                    $pharm_id = $animal_nutrition_block_3['animal_nutrition_block_3_image']['id'];
                    echo html_entity_decode(esc_html(
