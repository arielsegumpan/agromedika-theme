...
<main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-8 mx-auto text-center">
                    <h2 class="fw-bold mb-5 text-lteal pb-4"><?php echo esc_html($personal_care_cosmetics_block_2['personal_care_cosmetics_block_2_title']) ?></h2>
                </div>
                            ...
                            <div class="card border-0 bg-transparent text-center">
                                <div class="card-body">
                                    ...
                                    <div class="cont mt-4 pt-1">
                                        <div class="mb-3">
                                            <span class="fw-bold fs-4 text-lteal"><?php echo esc_html($get_pharm_icon['personal_care_cosmetics_block_2_title']); ?></span>
                                        </div>
    ...
    <?php if(!empty($personal_care_cosmetics_block_3['personal_care_cosmetics_block_3_content'])) :?>
        <section id="added_block" class="bg-lteal">
          <div class="container">
            <?php if(!empty($personal_care_cosmetics_block_3['personal_care_cosmetics_block_3_title'])) :?>
            <h2 class="fw-bold text-center mb-5 pb-lg-5"><?php echo esc_html( $personal_care_cosmetics_block_3['personal_care_cosmetics_block_3_title'] );?></h2>
            <?php endif;?>
            <div class="row">
              <div class="col-12 col-lg-6 mt-5 mt-lg-0 text-center text-lg-start">
                <div class="lh-lg text-secondary">
                    <?php echo html_entity_decode(esc_html($personal_care_cosmetics_block_3['personal_care_cosmetics_block_3_content'])); ?>
                </div>
                
              </div>
              <div class="col-12 col-lg-6 ps-lg-5 mt-5 mt-lg-0">
                <?php if (!empty($personal_care_cosmetics_block_3['personal_care_cosmetics_block_3_image']['url'])) : ?>
                    <?php
                    $pharm_id = $personal_care_cosmetics_block_3['personal_care_cosmetics_block_3_image']['id'];
                    echo html_entity_decode(esc_html(
   ...
   <?php get_template_part('template-parts/components/custompage/cosmetic', 'content');?>
