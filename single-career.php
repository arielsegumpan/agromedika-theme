...
$page_footer_soc_med = !empty($option_values['page_footer_soc_med']) ? $option_values['page_footer_soc_med'] : '';
            ...
            <div class="container-fluid px-0">
                <div class="row">
                    <div class="position-relative">
                        <?php echo has_post_thumbnail() ? wp_get_attachment_image($image_id, 'blog_thumbnail', false, array('class' => 'single-blog-img w-100')) : ''; ?>
                    ...
                    <?php if (have_posts()) : while (have_posts()) : the_post();
                            ...
                            <?php if (!empty($opening_position)): ?>
                                <div class="mt-1 text-secondary">
                                    <h4><i class="bi bi-briefcase me-2"></i> <?php echo esc_html($opening_position); ?></h4>
                                </div>
                            <?php endif; ?>
                        <?php endwhile;
                    endif; ?>
                    <?php if (shortcode_exists('get_career_related_categories')) : ?>
                        <div class="d-flex flex-wrap flex-row text-center g-5 text-md-start mt-4 justify-content-start align-items-start mb-4">
                            <?php echo do_shortcode('[get_career_related_categories]'); ?>
                        </div>
                    <?php endif ?>
                ...
                <div class="col-12 col-xl-3">
                    <div id="aside">
                        <div id="featured_prod_aside" class="mb-5">
                            ...
                            <div class="row">
                                <?php get_template_part('template-parts/components/aside/asidecareer', 'recent'); ?>
                            </div>
                        </div>
                        <?php
