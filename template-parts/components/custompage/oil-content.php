<?php if(have_posts()): while(have_posts()) : the_post(); ?>
    ...
    <section id="prod_cat_pharm">
        <div class="container">
            <?php if(!empty($essential_oil_block_4['essential_oil_block_4_title']) && !empty($essential_oil_block_4['essential_oil_block_4_content']))  :?>
            <div class="row mb-5 pb-4">
                <div class="col-12 col-lg-8 mx-auto text-center">
                <h2 class="fw-bold"><?php echo esc_html($essential_oil_block_4['essential_oil_block_4_title']);?></h2>
                <p class="lh-lg text-secondary mt-4"><?php echo html_entity_decode(esc_textarea($essential_oil_block_4['essential_oil_block_4_content']));?></p>
                </div>
            </div>
            <?php endif;?>
